...
<body>
    ...
    <section class="add-products">
        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <textarea name="deskripsi" class="box" placeholder="Enter Product Description" required></textarea>
            <textarea name="tujuan" class="box" placeholder="Enter Product Goal" required></textarea>
    ...
    <section class="edit-product-form">
        ...
        ?>
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <!-- Tambahkan input untuk deskripsi dan tujuan -->
                        <textarea name="update_deskripsi" class="box" required placeholder="Enter Product Description"><?php echo $fetch_update['deskripsi']; ?></textarea>
                        <textarea name="update_tujuan" class="box" required placeholder="Enter Product Goal"><?php echo $fetch_update['tujuan']; ?></textarea>
